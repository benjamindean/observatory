    ...
    return _then(_value.copyWith(
      ...
      deals: freezed == deals
          ...
          : deals // ignore: cast_nullable_to_non_nullable
              as List<Deal>?,
      selectedDeals: null == selectedDeals
...
class _$SteamImportStateImpl implements _SteamImportState {
  const _$SteamImportStateImpl(
      ...
      final List<Deal> selectedDeals = const [],
      this.error,
  ...
  List<Deal> get selectedDeals {
    if (_selectedDeals is EqualUnmodifiableListView) return _selectedDeals;
    // ignore: implicit_dynamic_type
  ...
  @override
  String toString() {
    return 'SteamImportState(username: $username, deals: $deals, selectedDeals: $selectedDeals, error: $error, isLoading: $isLoading, isImporting: $isImporting, focusNode: $focusNode, usernameInputController: $usernameInputController)';
  }
