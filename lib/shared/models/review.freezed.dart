...
abstract class $ReviewCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? score, String? source, num? count, String? url});
}
...
class _$ReviewImpl with DiagnosticableTreeMixin implements _Review {
  const _$ReviewImpl({this.score, this.source, this.count, this.url});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Review(score: $score, source: $source, count: $count, url: $url)';
  }
