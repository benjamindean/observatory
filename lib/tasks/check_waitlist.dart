...
//   final List<Deal> pastWaitlist = await settingsRepository.getWaitlistPast();
...
//       if ((pastValue.prices?.first.priceCut ?? 0) <
//           (deal.prices?.first.priceCut ?? 0)) {
//         return true;
//       }
...
//     })
//     ..removeWhere(
//       (deal) => deal.prices == null || (deal.prices?.first.priceCut ?? 0) == 0,
//     );
// }

// Future<bool> checkWaitlistTask() async {
//   final List<Deal> discountedDeals = await getNewDiscountedDeals();

//   return showWaitlistNotification(deals: discountedDeals);
// }
