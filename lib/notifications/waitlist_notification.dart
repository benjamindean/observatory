...
//     deals.length,
//     one:
//         '${deals[0].titleParsed} is ${deals[0].prices?[0].priceCut.toInt() ?? 0}% off at ${deals[0].prices?[0].shop.name ?? 'Unknown'}.',
//     other:
//         '${deals[0].titleParsed} is ${deals[0].prices?[0].priceCut.toInt() ?? 0}% off at ${deals[0].prices?[0].shop.name ?? 'Unknown'} and ${deals.length - 1} other $restText on sale right now.',
//   );
