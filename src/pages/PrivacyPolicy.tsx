...
export default function PrivacyPolicy() {
  return (
    <article className="prose max-w-6xl container mx-auto pt-16 pb-8 px-8">
      ...
      <div>
        <p>
          This privacy policy applies to the Observatory app (hereby referred to
          as &quot;Application&quot;) for mobile devices. This service is
        ...
        <p>This privacy policy is effective as of 2024-04-03</p>
        <p>
